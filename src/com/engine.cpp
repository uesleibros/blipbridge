...
constexpr DispatchEntry kDispatchEntries[] = {
    ...
    {L"LoadTextureScaledAbi", DispatchId::LoadTextureScaledAbi},
    {L"ApplyImageQuadAbi", DispatchId::ApplyImageQuadAbi},
    {L"ReleaseImageAbi", DispatchId::ReleaseImageAbi},
    {L"LoadImageAbi", DispatchId::LoadImageAbi},
