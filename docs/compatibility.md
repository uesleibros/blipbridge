...
Only this Office build is tested. Public-COM fallback uses discovered methods and does not call undocumented functions. No internal compatibility profiles are enabled. MemoryImageToFill and InternalBackend capabilities are false.
